...
// Define the types for BaseBeverage, Creamer, and Syrup
...
// Declare the arrays using ref and specify the type of the array elements
...
export { bases, creamers, syrups, currentTemp, temps};
